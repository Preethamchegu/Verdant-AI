...
*(This is the actual product vision — what makes Verdant AI more than a hackathon project. Each phase below needs either more build time or real usage data Day 1 can't have.)*

### Phase 2 — Adaptive Reminders & Live Integrations
Move rule-based reminders → learned/adaptive scheduling
Notifications
Calendar integration
Full weather-service integration (Day 1 only uses weather as a rule-planner input, not a live monitored feed)
...
Nearby experts via live Maps/Places API (not a hand-built directory)
Emergency escalation flow, fully wired
...
### Phase 6 — Environmental Analytics
Full carbon dashboard with historical trend (Day 1 ships a point-in-time estimate only)
...
IoT soil sensors
Drone monitoring
Government / municipal plantation program integrations
